...
contract Payibles is Context, IERC20, IERC20Metadata,Ownable {
    ...
    function Transfer_enabled() public view returns (bool){
        return transfer_enabled;
    }
   
    function Pause_transfer() public onlyOwner{
        require(transfer_enabled != false," traansfering assest is already paused");
         transfer_enabled = false;
    }
    
    function Continue_transfer() public onlyOwner{
         require(transfer_enabled != true," traansfering assest is already continued");
